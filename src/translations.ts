...
export const translations: Record<ReportLanguage, Translations> = {
  English: {
    ...
    finalLegalDisclaimer: "Legal Disclaimer: This is an entertainment service for inspiration and self-reflection. It is not a substitute for professional medical, financial, or legal advice. You are the author of your own destiny.",
    ...
    pitchSlide1Subtitle: "P2P Affiliate Platform: Astrology & Numerology for your audience.",
    ...
    s_prof_natal_title: "Natal Chart Decoding",
    s_prof_natal_desc: "Direct analytical decoding of your natal chart from an uploaded image. 15-page expert synthesis.",
    ...
    s_instant_desc: "Receive your 15-page report in your digital sanctuary within moments.",
    ...
    s_report_delivery: "Your report will be delivered as a 15-page PDF document, suitable for printing and long-term reflection. It includes detailed quarterly breakdowns, specific celestial windows of opportunity, and a psychological roadmap for your current cycle.",
    s_start_consultation: "Start Your Consultation",
    s_fee_wisdom: "Fee for Wisdom",
    s_prof_synthesis: "Synthesis",
    ...
    widgetSubtitle: "Enhance your website with the insights of Atlantic Oracle. Free, beautiful, and fully responsive widgets.",
    ...
    metaHomeDescription: "Discover your destiny with Atlantic Oracle. Reports on astrology, numerology, love synastry, and human design based on precise celestial data.",
  ...
  Portuguese: {
    ...
    finalLegalDisclaimer: "Aviso Legal: Este é um serviço de entretenimento para inspiração e autorreflexão. Não substitui aconselhamento médico, financeiro ou jurídico profissional. Você é o autor do seu próprio destino.",
    ...
    pitchSlide1Subtitle: "Plataforma de Afiliados P2P: Astrologia e Numerologia para sua audiência.",
    ...
    s_prof_natal_title: "Decodificação de Mapa Natal",
    s_prof_natal_desc: "Decodificação analítica direta do seu mapa natal a partir de uma imagem enviada. Síntese especializada de 15 páginas.",
    ...
    s_instant_desc: "Receba seu relatório de 15 páginas em seu santuário digital em poucos momentos.",
    ...
    s_report_delivery: "Seu relatório será entregue como um documento PDF de 15 páginas, adequado para impressão e reflexão de longo prazo. Inclui detalhamentos trimestrais detalhados, janelas celestiais específicas de oportunidade e um roteiro psicológico para seu ciclo atual.",
    s_start_consultation: "Iniciar sua Consulta",
    s_fee_wisdom: "Taxa de Sabedoria",
    s_prof_synthesis: "Síntese",
    ...
    widgetSubtitle: "Melhore o seu site com as ideias do Atlantic Oracle. Widgets gratuitos, bonitos e totalmente responsivos.",
    ...
    metaHomeDescription: "Descubra o seu destino com o Atlantic Oracle. Relatórios de astrologia, numerologia, sinastria amorosa e human design baseados em dados celestiais precisos.",
  ...
  Spanish: {
    ...
    finalLegalDisclaimer: "Aviso Legal: Este es un servicio de entretenimiento para la inspiración y la autorreflexión. No sustituye el asesoramiento profesional médico, financiero o legal. Tú eres el autor de tu propio destino.",
    ...
    pitchSlide1Subtitle: "Plataforma de Afiliados P2P: Astrología y Numerología para tu audiencia.",
    ...
    s_prof_natal_title: "Decodificación de Carta Natal",
    s_prof_natal_desc: "Decodificación analítica directa de su carta natal a partir de una imagen cargada. Síntesis experta de 15 páginas.",
    ...
    s_instant_desc: "Recibe tu informe de 15 páginas en tu santuario digital en cuestión de momentos.",
    ...
    s_report_delivery: "Tu informe se entregará como un documento PDF de 15 páginas, adecuado para imprimir y para la reflexión a largo plazo. Inclui desgloses trimestrales detallados, ventanas celestiales específicas de oportunidad y una hoja de ruta psicológica para tu ciclo actual.",
    s_start_consultation: "Iniciar tu Consulta",
    s_fee_wisdom: "Tarifa por Sabiduría",
    s_prof_synthesis: "Síntesis",
    ...
    cosmicDecreeOf: "Decreto Cósmico de",
    widgetTitle: "Widgets para Webmasters",
    widgetSubtitle: "Mejore su sitio web con las perspectivas de Atlantic Oracle. Widgets gratuitos, hermosos y totalmente adaptables.",
    ...
    metaHomeDescription: "Descubre tu destino con el Oráculo Atlántico. Informes de astrología, numerología, sinastría de amor y diseño humano basados en datos celestiales precisos.",
