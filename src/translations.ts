...
export interface Translations {
  ...
  heroCTA: string;
  heroFreeCTA: string;
  freeInsightsTitle: string;
  freeInsightsSubtitle: string;
  decreesTitle: string;
  decreesSubtitle: string;
  philosophyTitle: string;
  philosophySubtitle: string;
  philosophyText: string;
  featureReports: string;
  featureReportsDesc: string;
  featureMethodology: string;
  featureMethodologyDesc: string;
  ...
  locationEssential: string;
  partnerIdentityNeeded: string;
  dreamDescriptionRequired: string;
  dreamKeywordsHelpful: string;
  feeForWisdom: string;
  start: string;
  proceedToPayment: string;
  oracleInsight: string;
  oraclesDecree: string;
  starsWhisper: string;
  sacredRegistry: string;
  seekerLabel: string;
  seekAnotherTruth: string;
  savePdf: string;
  ...
  consulting: string;
  monthlyGift: string;
  unlockFullDecree: string;
  experienceDepth: string;
  consultFullOracle: string;
  sagesRequirement: string;
  sagesRequirementDesc: string;
  loadingTitle: string;
  loadingSubtitle: string;
  loadingPhase1: string;
  loadingPhase2: string;
  ...
  philosophySynthesis: string;
  philosophyAlignment: string;
  philosophySignature: string;
  ...
  whyItResonatesTitle: string;
  whyItResonatesSubtitle: string;
  whyItResonatesIntro: string;
  asAboveTitle: string;
  asAboveDesc: string;
  vibrationalTitle: string;
  vibrationalDesc: string;
  synchronicityTitle: string;
  synchronicityDesc: string;
  psychologicalTitle: string;
  psychologicalDesc: string;
  freeWillDisclaimer: string;
  saveCherishTitle: string;
  saveCherishDesc: string;
  privacySovereigntyTitle: string;
  privacySovereigntyDesc: string;
  readyToListen: string;
  consultSecretLanguage: string;
  finalLegalDisclaimer: string;
  ...
  pitchSlide8Badge: string;
  pitchSlide9Badge: string;
  pitchSlide10Badge: string;
  pitchSlide5ClientTitle: string;
  pitchSlide5PartnerTitle: string;
  pitchWinWin: string;
  pitchDealerProgram: string;
  pitchDealerSubtitle: string;
...
export const translations: Record<ReportLanguage, Translations> = {
  English: {
    ...
    heroTitle: "The Secret Language of Space and Numbers",
    ...
    philosophySubtitle: "Atlantic Oracle™ represents a shift from general horoscopes to structured data analysis.",
    philosophyText: "We believe that Astrology provides the external context—the \"weather\" of your destiny—while Numerology reveals the internal engine: the vibrations hidden in your name and date of birth.",
    featureReports: "3-5 Page Reports",
    featureReportsDesc: "Substantial analysis ranging from 800 to 1500 words per reading.",
    featureMethodology: "Dual Methodology",
    featureMethodologyDesc: "The synthesis of celestial transits and the Pythagorean matrix.",
    featurePrivacy: "Ephemeral Privacy",
    featurePrivacyDesc: "No personal accounts. Your data is deleted immediately after the report.",
    footerTagline: "The stars do not command, they whisper truth to the soul.",
    footerCopyright: "© 2026 Atlantic Oracle™. All rights reserved.",
    backToStart: "Back to start",
    returnToSanctuary: "Return to Sanctuary",
    identityRequired: "Identity is required",
    locationEssential: "Location is essential",
    partnerIdentityNeeded: "Partner identity needed",
    dreamDescriptionRequired: "Dream description is required",
    dreamKeywordsHelpful: "Key images are helpful for the sage",
    feeForWisdom: "Fee for Wisdom",
    start: "START",
    proceedToPayment: "PROCEED TO PAYMENT",
    oracleInsight: "Oracle Insight",
    oraclesDecree: "The Oracle's Decree",
    starsWhisper: "\"The stars do not command, they whisper truth to the soul.\"",
    sacredRegistry: "Sacred Registry",
    seekerLabel: "For the seeker:",
    seekAnotherTruth: "Seek Another Truth",
    savePdf: "Save Registry PDF",
    copyClipboard: "Copy to Clipboard",
    copiedMessage: "The decree has been copied to your clipboard.",
    shareWisdom: "Share the Wisdom",
    spreadLight: "Spread the cosmic light to your circle.",
    close: "Close",
    claimGift: "Claim Monthly Forecast",
    giftAwaits: "A Celestial Gift Awaits",
    giftForecast: "The oracle has prepared a special 30-day personal forecast as a token of cosmic alignment.",
    consulting: "Consulting...",
    monthlyGift: "Your Monthly Gift",
    unlockFullDecree: "Unlock Your Full Cosmic Decree",
    experienceDepth: "Experience the depth of a 3-5 page analysis mapping your entire soul's architectural blueprint and karmic path.",
    consultFullOracle: "Consult Full Oracle",
    sagesRequirement: "Sage's Requirement",
    sagesRequirementDesc: "For a deeper and more precise analysis, we require additional coordinates. Please fill out the form with utmost accuracy. Note that the oracle requires a moment of celestial silence to weave your comprehensive decree.",
    loadingTitle: "Consulting the Registry",
    loadingSubtitle: "The Oracle is weaving your celestial coordinates into a comprehensive decree. Please wait, this process takes a moment as we calculate deep cosmic alignments.",
    loadingPhase1: "Aligning celestial transits...",
    loadingPhase2: "Calculating numerical vibrations...",
    loadingPhase3: "Synthesizing soul architecture...",
    loadingPhase4: "Finalizing the sacred registry...",
    philosophyQuote: "Destiny is not a cage, but a set of coordinates.",
    philosophyIntro: "We view life as a complex interplay of natural rhythms. Just as a navigator needs both a compass and a map of the stars, a person seeking harmony needs to understand both their internal frequency and the external environment.",
    astrologyTitle: "Astrology",
    astrologyDesc: "Astrology is the study of cosmic cycles and planetary transits. It reveals the \"climate\" of your life—when to act, when to wait, and where the universal energy is flowing at any given moment.",
    numerologyTitle: "Numerology",
    numerologyDesc: "Numerology decodes the structural vibration of your name and birth date. It describes your \"engine\"—the innate qualities, strengths, and spiritual lessons that define your unique identity.",
    philosophySynthesis: "By combining these two ancient disciplines, we provide a high-resolution view of your path, allowing you to move in sync with the world rather than against it.",
    philosophyAlignment: "When the internal vibration (Numbers) aligns with the external rhythm (Stars), friction disappears. This is the state of natural flow we help our visitors achieve.",
    philosophySignature: "Deciphering the secret language of the stars.",
    howItWorksTitle: "The Sacred Process",
    howItWorksSubtitle: "How we weave your comprehensive decree.",
    step1Title: "Celestial Coordinates",
    step1Desc: "We collect your birth data and name, the fundamental coordinates of your soul's entry into the physical plane.",
    step2Title: "Mathematical Synthesis",
    step2Desc: "Our engine calculates the Pythagorean matrix of your name and the precise planetary transits at your moment of birth.",
    step3Title: "Decree Generation",
    step3Desc: "The Oracle synthesizes these data points into a 3-5 page comprehensive report mapping your karmic path.",
    howItWorksSummary: "Your data is ephemeral. We do not store personal information after the report is generated.",
    whyItResonatesTitle: "Why It Feels Like It “Works”",
    whyItResonatesSubtitle: "The Deeper Philosophical Reasoning",
    whyItResonatesIntro: "Astrology and numerology are not claiming physical causation like gravity — they operate as symbolic languages rooted in ancient philosophy:",
    asAboveTitle: "“As above, so below”",
    asAboveDesc: "The Hermetic principle suggests the macrocosm mirrors the microcosm. Celestial positions serve as a timeless map of archetypes — not forcing outcomes, but reflecting patterns of energy and timing.",
    vibrationalTitle: "Vibrational correspondence",
    vibrationalDesc: "Pythagoras taught that everything reduces to fundamental vibrations. We decode the “signature” imprinted at birth, revealing innate tendencies and rhythmic lessons through number and planet.",
    synchronicityTitle: "Synchronicity & Patterns",
    synchronicityDesc: "Carl Jung described synchronicity as acausal connections through meaning. These systems excel at highlighting recurring themes, triggering self-recognition and alignment with your inner truth.",
    psychologicalTitle: "Psychological Reflective Power",
    psychologicalDesc: "Even without physical proof, these systems function like powerful therapeutic mirrors: they prompt self-inquiry, highlight potentials, and provide frameworks for translating intuition into words.",
    freeWillDisclaimer: "\"We never promise predictions as certainties — free will, choices, and context always shape outcomes. The cosmos illuminates possibilities; you decide how to walk them.\"",
    saveCherishTitle: "Save & Cherish",
    saveCherishDesc: "Download your reading as an elegant PDF: cosmic design, ready to print or share as a meaningful present.",
    privacySovereigntyTitle: "Privacy & Sovereignty",
    privacySovereigntyDesc: "Your coordinates are processed only for the session. Data is deleted immediately after your PDF is generated.",
    readyToListen: "Ready to listen?",
    consultSecretLanguage: "Consult the Secret Language",
    finalLegalDisclaimer: "Final Reminder: This is a tool for entertainment, inspiration, and self-reflection. It is not a substitute for professional medical, financial, or legal advice. You are the author of your own destiny.",
    testimonialsTitle: "Echoes from the Souls",
    testimonialsSubtitle: "Voices of those who walked the path before you.",
    privacyPolicy: "Privacy Policy",
    contactSupport: "Contact • Suggestions • Support",
    testimonial1Quote: "Mind-blown.",
    testimonial1Text: "Finally, something that actually resonates. That 'Projector' advice hit home. It’s like they’ve known me my whole life.",
    testimonial2Quote: "So accurate!",
    testimonial2Text: "The report is beautiful and very deep. I printed my Decree and put it on my desk. It gives me so much peace.",
    testimonial3Quote: "Simply perfect.",
    testimonial3Text: "I love the golden stars! The words are true and the PDF is very good. My destiny is clear now. 10/10.",
    timeLabel: "Time:",
    whenDidItHappen: "When did it happen?",
    approximateTime: "Approximate Time:",
    shareTitle: "Atlantic Oracle™ Decree",
    shareText: "I just received my personal cosmic reading from Atlantic Oracle™! 🌌 Explore your path at atlanticoracle.com",
    ...
    pitchSlide2Badge: "The Pain",
    pitchSlide3Badge: "The Solution",
    pitchSlide4Badge: "What we sell",
    pitchSlide5Badge: "The Offer",
    pitchSlide6Badge: "Trust",
    pitchSlide7Badge: "The Opportunity",
    pitchSlide8Badge: "Market Trend",
    pitchSlide9Badge: "Onboarding",
    pitchSlide10Badge: "The Closing",
    pitchSlide5ClientTitle: "For your Client",
    pitchSlide5PartnerTitle: "For You",
    pitchWinWin: "Win-Win Partnership",
    pitchDealerProgram: "Dealer Program",
    pitchDealerSubtitle: "Monetize your audience by sharing the wisdom of the stars and numbers.",
    ...
    horoscopeForecastLabel: "Celestial Forecast",
  ...
  Portuguese: {
    ...
    heroTitle: "A Linguagem Secreta do Espaço e dos Números",
    ...
    philosophySubtitle: "Atlantic Oracle™ representa uma mudança de horóscopos gerais para análise de dados estruturados.",
    philosophyText: "Acreditamos que a Astrologia fornece o contexto externo — o \"clima\" do seu destino — enquanto a Numerologia revela o motor interno: as vibrações ocultas no seu nome e data de nascimento.",
    featureReports: "Relatórios de 3-5 Páginas",
    featureReportsDesc: "Análise substancial variando de 800 a 1500 palavras por leitura.",
    featureMethodology: "Metodologia Dupla",
    featureMethodologyDesc: "A síntese de trânsitos celestiais e a matriz pitagórica.",
    featurePrivacy: "Privacidade Efêmera",
    featurePrivacyDesc: "Sem contas pessoais. Seus dados são excluídos imediatamente após o relatório.",
    footerTagline: "As estrelas não comandam, elas sussurram a verdade para a alma.",
    footerCopyright: "© 2026 Atlantic Oracle™. Todos os direitos reservados.",
    backToStart: "Voltar ao início",
    returnToSanctuary: "Retornar ao Santuário",
    identityRequired: "A identidade é obrigatória",
    locationEssential: "A localização é essencial",
    partnerIdentityNeeded: "Identidade do parceiro necessária",
    dreamDescriptionRequired: "A descrição do sonho é obrigatória",
    dreamKeywordsHelpful: "Imagens-chave são úteis para o sábio",
    feeForWisdom: "Taxa pela Sabedoria",
    start: "INICIAR",
    proceedToPayment: "PROSSEGUIR PARA O PAGAMENTO",
    oracleInsight: "Insight do Oráculo",
    oraclesDecree: "O Decreto do Oráculo",
    starsWhisper: "\"As estrelas não comandam, elas sussurram a verdade para a alma.\"",
    sacredRegistry: "Registro Sagrado",
    seekerLabel: "Para o buscador:",
    seekAnotherTruth: "Buscar Outra Verdade",
    savePdf: "Salvar PDF do Registro",
    copyClipboard: "Copiar para a Área de Transferência",
    copiedMessage: "O decreto foi copiado para sua área de transferência.",
    shareWisdom: "Compartilhar a Sabedoria",
    spreadLight: "Espalhe a luz cósmica para o seu círculo.",
    close: "Fechar",
    claimGift: "Resgatar Previsão Mensal",
    giftAwaits: "Um Presente Celestial Aguarda",
    giftForecast: "O oráculo preparou uma previsão pessoal especial de 30 dias como um símbolo de alinhamento cósmico.",
    consulting: "Consultando...",
    monthlyGift: "Seu Presente Mensal",
    unlockFullDecree: "Desbloqueie seu Decreto Cósmico Completo",
    experienceDepth: "Experimente a profundidade de uma análise de 3-5 páginas mapeando todo o projeto arquitetônico da sua alma e caminho cármico.",
    consultFullOracle: "Consultar Oráculo Completo",
    sagesRequirement: "Requisito do Sábio",
    sagesRequirementDesc: "Para uma análise mais profunda e precisa, solicitamos coordenadas adicionais. Por favor, preencha o formulário com a máxima precisão. Note que o oráculo requer um momento de silêncio celestial para tecer seu decreto abrangente.",
    loadingTitle: "Consultando o Registro",
    loadingSubtitle: "O Oráculo está tecendo suas coordenadas celestiais em um decreto abrangente. Por favor, aguarde, este processo leva um momento enquanto calculamos alinhamentos cósmicos profundos.",
    loadingPhase1: "Alinhando trânsitos celestiais...",
    loadingPhase2: "Calculando vibrações numéricas...",
    loadingPhase3: "Sintetizando a arquitetura da alma...",
    loadingPhase4: "Finalizando o registro sagrado...",
    philosophyQuote: "O destino não é uma gaiola, mas um conjunto de coordenadas.",
    philosophyIntro: "Vemos a vida como uma complexa interação de ritmos naturais. Assim como um navegador precisa de uma bússola e de um mapa das estrelas, uma pessoa que busca harmonia precisa entender tanto sua frequência interna quanto o ambiente externo.",
    astrologyTitle: "Astrologia",
    astrologyDesc: "A Astrologia é o estudo dos ciclos cósmicos e trânsitos planetários. Ela revela o \"clima\" da sua vida — quando agir, quando esperar e para onde a energia universal está fluindo em qualquer momento.",
    numerologyTitle: "Numerologia",
    numerologyDesc: "A Numerologia decodifica a vibração estrutural do seu nome e data de nascimento. Ela descreve seu \"motor\" — as qualidades inatas, forças e lições espirituais que definem sua identidade única.",
    philosophySynthesis: "Ao combinar estas duas disciplinas ancestrais, fornecemos uma visão de alta resolução do seu caminho, permitindo que você se mova em sincronia com o mundo em vez de contra ele.",
    philosophyAlignment: "Quando a vibração interna (Números) se alinha com o ritmo externo (Estrelas), a fricção desaparece. Este é o estado de fluxo natural que ajudamos nossos visitantes a alcançar.",
    philosophySignature: "Decifrando a linguagem secreta das estrelas.",
    howItWorksTitle: "O Processo Sagrado",
    howItWorksSubtitle: "Como tecemos seu decreto abrangente.",
    ...
    whyItResonatesTitle: "Por que Parece que “Funciona”",
    whyItResonatesSubtitle: "O Raciocínio Filosófico Profundo",
    whyItResonatesIntro: "A astrologia e a numerologia não reivindicam causalidade física como a gravidade — elas operam como linguagens simbólicas enraizadas na filosofia antiga:",
    asAboveTitle: "“Assim como é em cima, é embaixo”",
    asAboveDesc: "O princípio hermético sugere que o macrocosmo reflete o microcosmo. As posições celestiais servem como um mapa atemporal de arquétipos — não forçando resultados, mas refletindo padrões de energia e tempo.",
    vibrationalTitle: "Correspondência vibracional",
    vibrationalDesc: "Pitágoras ensinou que tudo se reduz a vibrações fundamentais. Decodificamos a “assinatura” impressa no nascimento, revelando tendências inatas e lições rítmicas através de números e planetas.",
    synchronicityTitle: "Sincronicidade e Padrões",
    synchronicityDesc: "Carl Jung descreveu a sincronicidade como conexões acausais através do significado. Estes sistemas se destacam em destacar temas recorrentes, desencadeando o autorreconhecimento e o alinhamento com sua verdade interior.",
    psychologicalTitle: "Poder de Reflexão Psicológica",
    psychologicalDesc: "Mesmo sem prova física, estes sistemas funcionam como espelhos terapêuticos poderosos: eles estimulam a autoindagação, destacam potenciais e fornecem estruturas para traduzir a intuição em palavras.",
    freeWillDisclaimer: "\"Nunca prometemos previsões como certezas — o livre arbítrio, as escolhas e o contexto sempre moldam os resultados. O cosmos ilumina possibilidades; você decide como percorrê-las.\"",
    saveCherishTitle: "Salvar e Valorizar",
    saveCherishDesc: "Baixe sua leitura como um PDF elegante: design cósmico, pronto para imprimir ou compartilhar como um presente significativo.",
    privacySovereigntyTitle: "Privacidade e Soberania",
    privacySovereigntyDesc: "Suas coordenadas são processadas apenas para a sessão. Os dados são excluídos imediatamente após a geração do seu PDF.",
    readyToListen: "Pronto para ouvir?",
    consultSecretLanguage: "Consultar a Linguagem Secreta",
    finalLegalDisclaimer: "Lembrete Final: Esta é uma ferramenta para entretenimento, inspiração e autorreflexão. Não substitui aconselhamento profissional médico, financeiro ou jurídico. Você é o autor do seu próprio destino.",
    testimonialsTitle: "Ecos das Almas",
    testimonialsSubtitle: "Vozes daqueles que trilharam o caminho antes de você.",
    privacyPolicy: "Política de Privacidade",
    contactSupport: "Contato • Sugestões • Suporte",
    testimonial1Quote: "Impressionante.",
    testimonial1Text: "Finalmente, algo que realmente ressoa. Aquele conselho sobre 'Projetor' acertou em cheio. É como se eles me conhecessem a vida toda.",
    testimonial2Quote: "Tão preciso!",
    testimonial2Text: "O relatório é lindo e muito profundo. Imprimi meu Decreto e o coloquei na minha mesa. Isso me dá muita paz.",
    testimonial3Quote: "Simplesmente perfeito.",
    testimonial3Text: "Eu amo as estrelas douradas! As palavras são verdadeiras e o PDF é muito bom. Meu destino está claro agora. 10/10.",
    timeLabel: "Hora:",
    whenDidItHappen: "Quando aconteceu?",
    approximateTime: "Hora Aproximada:",
    shareTitle: "Decreto do Atlantic Oracle™",
    shareText: "Acabei de receber minha leitura cósmica pessoal do Atlantic Oracle™! 🌌 Explore seu caminho em atlanticoracle.com",
    ...
    pitchSlide2Badge: "O Problema",
    pitchSlide3Badge: "A Solução",
    pitchSlide4Badge: "O Produto",
    pitchSlide5Badge: "A Oferta",
    pitchSlide6Badge: "Confiança",
    pitchSlide7Badge: "Oportunidade",
    pitchSlide8Badge: "Tendência de Mercado",
    pitchSlide9Badge: "Integração",
    pitchSlide10Badge: "O Encerramento",
    pitchSlide5ClientTitle: "Para seu Cliente",
    pitchSlide5PartnerTitle: "Para Você",
    ...
    horoscopeForecastLabel: "Previsão Celestial",
    horoscopeToday: "Hoje",
  ...
  Spanish: {
    ...
    navConsult: "Consultar Oráculo",
    heroTitle: "El Lenguaje Secreto del Espacio y los Números",
    heroBadge: "Mecánica Celestial y Vibraciones Numéricas",
    heroSubtitle: "Una síntesis de mecánica celestial y vibraciones numéricas. Descubre tu plano arquitectónico.",
    heroCTA: "Consultar el Oráculo",
    heroFreeCTA: "The Light Drops",
    freeInsightsTitle: "The Light Drops",
    freeInsightsSubtitle: "Perspectivas de IA rápidas y concentradas para una claridad instantánea.",
    decreesTitle: "Decretos Cósmicos",
    ...
    featureMethodologyDesc: "La síntesis de tránsitos celestiales y la matriz pitagórica.",
    featurePrivacy: "Privacidad Efímera",
    featurePrivacyDesc: "Sin cuentas personales. Tus datos se eliminan inmediatamente después del informe.",
    footerTagline: "Las estrellas no mandan, susurran la verdad al alma.",
    footerCopyright: "© 2026 Atlantic Oracle™. Todos los derechos reservados.",
    backToStart: "Volver al inicio",
    returnToSanctuary: "Regresar al Santuario",
    identityRequired: "Se requiere identidad",
    locationEssential: "La ubicación es esencial",
    partnerIdentityNeeded: "Se necesita la identidad de la pareja",
    dreamDescriptionRequired: "Se requiere descripción del sueño",
    dreamKeywordsHelpful: "Las imágenes clave son útiles para el sabio",
    feeForWisdom: "Tarifa por Sabiduría",
    start: "INICIAR",
    proceedToPayment: "PROCEDER AL PAGO",
    oracleInsight: "Perspectiva del Oráculo",
    oraclesDecree: "El Decreto del Oráculo",
    starsWhisper: "\"Las estrellas no mandan, susurran la verdad al alma.\"",
    sacredRegistry: "Registro Sagrado",
    seekerLabel: "Para el buscador:",
    seekAnotherTruth: "Buscar Otra Verdad",
    savePdf: "Guardar PDF del Registro",
    copyClipboard: "Copiar al Portapapeles",
    copiedMessage: "El decreto ha sido copiado a tu portapapeles.",
    shareWisdom: "Compartir la Sabiduría",
    spreadLight: "Difunde la luz cósmica a tu círculo.",
    close: "Cerrar",
    claimGift: "Reclamar Pronóstico Mensual",
    giftAwaits: "Un Regalo Celestial te Espera",
    giftForecast: "El oráculo ha preparado un pronóstico personal especial de 30 días como muestra de alineación cósmica.",
    consulting: "Consultando...",
    ...
    loadingPhase2: "Calculando vibraciones numéricas...",
    loadingPhase3: "Sintetizando la arquitectura del alma...",
    loadingPhase4: "Finalizando el registro sagrado...",
    ...
    contactSupport: "Contacto • Sugerencias • Soporte",
    testimonial1Quote: "Asombroso.",
    testimonial1Text: "Finalmente, algo que realmente resuena. Ese consejo de 'Proyector' dio en el clavo. Es como si me conocieran de toda la vida.",
    testimonial2Quote: "¡Tan preciso!",
    testimonial2Text: "El informe es hermoso и muy profundo. Imprimí mi Decreto и lo puse en mi escritorio. Me da mucha paz.",
    testimonial3Quote: "Simplemente perfecto.",
    testimonial3Text: "¡Amo las estrellas doradas! Las palabras son ciertas и el PDF es muy bueno. Mi destino está claro ahora. 10/10.",
    timeLabel: "Hora:",
    whenDidItHappen: "¿Cuándo sucedió?",
    approximateTime: "Hora Aproximada:",
    shareTitle: "Decreto de Atlantic Oracle™",
    shareText: "¡Acabo de recibir mi lectura cósmica personal de Atlantic Oracle™! 🌌 Explora tu camino en atlanticoracle.com",
    latestTransmission: "Última Transmisión",
    readFullGazette: "Leer la Gaceta Completa",
    joinedBySeekers: "Se unieron más de 1,200 buscadores esta semana",
    newsSubtitle: "Transmisiones celestiales para el alma moderna.",
    viewAllNews: "Ver Todas las Noticias",
    formName: "Nombre Completo",
    formBirthDate: "Fecha de Nacimiento",
    formBirthDatePlaceholder: "DD/MM/AAAA",
    formBirthPlace: "Lugar de Nacimiento",
    formBirthPlacePlaceholder: "Ciudad, País",
    formBirthTime: "Hora de Nacimiento",
    formBirthTimePlaceholder: "ej. 14:30 o 2:30 PM",
    formBirthTimeHelp: "Use el formato de 24h (14:30) o el formato de 12h con AM/PM (2:30 PM).",
    formHours: "Horas",
    formMinutes: "Minutos",
    formAM: "AM",
    formPM: "PM",
    ...
    cookieRejectAll: "Solo Esenciales",
    cookieSettings: "Ajustes",
    ...
    navDealer: "Hacerse Distribuidor",
    dealerContactTitle: "Contacto rápido:",
    dealerContactWhatsApp: "Chat de WhatsApp",
    ...
    pitchSlide2Point3: "Desconfianza de la audiencia ante ofertas \"vacías\".",
    pitchSlide2Message: "Tú creas el contenido, pero las plataformas se llevan el beneficio principal.",
    ...
    pitchSlide5Partner: "Para ti: 50% de los ingresos netos de cada venta.",
    pitchSlide5Result: "Resultado: Audiencia leal (diste valor con un descuento) + altos ingresos.",
    pitchSlide6Title: "Transparencia Financiera con Stripe",
    pitchSlide6Text1: "No te pedimos que confíes en nuestra palabra.",
    pitchSlide6Text2: "Integración con el líder mundial en pagos — Stripe.",
    ...
    pitchSlide2Badge: "El Problema",
    pitchSlide3Badge: "La Solución",
    pitchSlide4Badge: "El Producto",
    pitchSlide5Badge: "La Oferta",
    pitchSlide6Badge: "Confianza",
    pitchSlide7Badge: "Oportunidad",
    pitchSlide8Badge: "Tendencia de Mercado",
    pitchSlide9Badge: "Integración",
    ...
    horoscopeLoading: "Consultando las estrellas para mañana...",
    horoscopeCTA: "Explorar Otros Servicios",
    horoscopeInvite: "Las estrellas tienen más que decirte. Explora nuestros decretos cósmicos integrales.",
    horoscopeForecastLabel: "Pronóstico Celestial",
    horoscopeToday: "Hoy",
  ...
  Russian: {
    ...
    heroTitle: "Секретный Язык Пространства и Чисел",
    heroBadge: "Небесная Механика и Числовые Вибрации",
    heroSubtitle: "Синтез небесной механики и числовых вибраций. Откройте свой архитектурный чертеж.",
    heroCTA: "Спросить Оракула",
    heroFreeCTA: "Капли Света",
    freeInsightsTitle: "Капли Света",
    freeInsightsSubtitle: "Быстрые, концентрированные идеи ИИ для мгновенной ясности.",
    decreesTitle: "Космические Указы",
    decreesSubtitle: "Выберите область фокуса для вашего всестороннего изучения.",
    philosophyTitle: "Единая Карта Вашего Существования",
    philosophySubtitle: "Atlantic Oracle™ представляет собой переход от общих гороскопов к структурированному анализу данных.",
    philosophyText: "Мы верим, что Астрология обеспечивает внешний контекст — «погоду» вашей судьбы, в то время как Нумерология раскрывает внутренний двигатель: вибрации, скрытые в вашем имени и дате рождения.",
    featureReports: "Отчеты на 3-5 Страниц",
    featureReportsDesc: "Существенный анализ объемом от 800 до 1500 слов на одно чтение.",
    featureMethodology: "Двойная Методология",
    featureMethodologyDesc: "Синтез небесных транзитов и пифагорейской матрицы.",
    featurePrivacy: "Эфемерная Конфиденциальность",
    featurePrivacyDesc: "Никаких личных аккаунтов. Ваши данные удаляются сразу после создания отчета.",
    footerTagline: "Звезды не приказывают, они шепчут истину душе.",
    footerCopyright: "© 2026 Atlantic Oracle™. Все права защищены.",
    backToStart: "Вернуться в начало",
    returnToSanctuary: "Вернуться в Святилище",
    identityRequired: "Требуется идентификация",
    locationEssential: "Местоположение имеет важное значение",
    partnerIdentityNeeded: "Требуется идентификация партнера",
    dreamDescriptionRequired: "Требуется описание сна",
    dreamKeywordsHelpful: "Ключевые образы полезны для мудреца",
    feeForWisdom: "Плата за Мудрость",
    start: "НАЧАТЬ",
    proceedToPayment: "ПЕРЕЙТИ К ОПЛАТЕ",
    oracleInsight: "Прозрение Оракула",
    oraclesDecree: "Указ Оракула",
    starsWhisper: "«Звезды не приказывают, они шепчут истину душе».",
    sacredRegistry: "Священный Реестр",
    seekerLabel: "Для ищущего:",
    seekAnotherTruth: "Искать Другую Истину",
    savePdf: "Сохранить Реестр в PDF",
    copyClipboard: "Копировать в Буфер Обмена",
    copiedMessage: "Указ был скопирован в буфер обмена.",
    shareWisdom: "Поделиться Мудростью",
    spreadLight: "Распространите космический свет в своем кругу.",
    close: "Закрыть",
    claimGift: "Получить Месячный Прогноз",
    giftAwaits: "Вас Ждет Небесный Подарок",
    giftForecast: "Оракул подготовил специальный 30-дневный личный прогноз в знак космического выравнивания.",
    consulting: "Консультация...",
    monthlyGift: "Ваш Ежемесячный Подарок",
    unlockFullDecree: "Разблокируйте Свой Полный Космический Указ",
    experienceDepth: "Ощутите глубину анализа на 3-5 страницах, отображающего весь архитектурный чертеж вашей души и кармический путь.",
    consultFullOracle: "Консультация Полного Оракула",
    sagesRequirement: "Требование Мудреца",
    sagesRequirementDesc: "Для более глубокого и точного анализа нам требуются дополнительные координаты. Пожалуйста, заполните форму с максимальной точностью. Обратите внимание, что оракулу требуется момент небесной тишины, чтобы соткать ваш всеобъемлющий указ.",
    loadingTitle: "Консультация с Реестром",
    loadingSubtitle: "Оракул вплетает ваши небесные координаты во всеобъемлющий указ. Пожалуйста, подождите, этот процесс занимает некоторое время, так как мы рассчитываем глубокие космические выравнивания.",
    loadingPhase1: "Выравнивание небесных транзитов...",
    loadingPhase2: "Расчет числовых вибраций...",
    loadingPhase3: "Синтез архитектуры души...",
    loadingPhase4: "Завершение священного реестра...",
    philosophyQuote: "Судьба — это не клетка, а набор координат.",
    philosophyIntro: "Мы рассматриваем жизнь как сложное взаимодействие природных ритмов. Подобно тому, как штурману нужны и компас, и карта звездного неба, человеку, ищущему гармонии, необходимо понимать как свою внутреннюю частоту, так и внешнюю среду.",
    astrologyTitle: "Астрология",
    astrologyDesc: "Астрология — это изучение космических циклов и планетных транзитов. Она раскрывает «климат» вашей жизни — когда действовать, когда ждать и куда течет универсальная энергия в любой данный момент.",
    numerologyTitle: "Нумерология",
    numerologyDesc: "Нумерология расшифровывает структурную вибрацию вашего имени и даты рождения. Она описывает ваш «двигатель» — врожденные качества, сильные стороны и духовные уроки, определяющие вашу уникальную личность.",
    philosophySynthesis: "Объединяя эти две древние дисциплины, мы обеспечиваем детальное видение вашего пути, позволяя вам двигаться в синхронности с миром, а не против него.",
    philosophyAlignment: "Когда внутренняя вибрация (Числа) совпадает с внешним ритмом (Звезды), трение исчезает. Это состояние естественного потока, которого мы помогаем достичь нашим посетителям.",
    philosophySignature: "Расшифровка секретного языка звезд.",
    howItWorksTitle: "Священный Процесс",
    howItWorksSubtitle: "Как мы создаем ваш всеобъемлющий указ.",
    step1Title: "Небесные Координаты",
    step1Desc: "Мы собираем данные о вашем рождении и имени — фундаментальные координаты вхождения вашей души в физический план.",
    step2Title: "Математический Синтез",
    step2Desc: "Наш движок рассчитывает пифагорейскую матрицу вашего имени и точные планетные транзиты в момент вашего рождения.",
    step3Title: "Генерация Указа",
    step3Desc: "Оракул синтезирует эти точки данных в всеобъемлющий отчет на 3-5 страницах, отображающий ваш кармический путь.",
    howItWorksSummary: "Ваши данные эфемерны. Мы не храним личную информацию после создания отчета.",
    whyItResonatesTitle: "Почему кажется, что это «работает»",
    whyItResonatesSubtitle: "Глубокое философское обоснование",
    whyItResonatesIntro: "Астрология и нумерология не претендуют на физическую причинно-следственную связь, как гравитация — они действуют как символические языки, укорененные в древней философии:",
    asAboveTitle: "«Что наверху, то и внизу»",
    asAboveDesc: "Герметический принцип предполагает, что макрокосм отражает микрокосм. Положения небесных тел служат вневременной картой архетипов — не принуждая к результатам, а отражая паттерны энергии и времени.",
    vibrationalTitle: "Вибрационное соответствие",
    vibrationalDesc: "Пифагор учил, что все сводится к фундаментальным вибрациям. Мы расшифровываем «подпись», запечатленную при рождении, раскрывая врожденные склонности и ритмические уроки через числа и планеты.",
    synchronicityTitle: "Синхронистичность и Паттерны",
    synchronicityDesc: "Карл Юнг описывал синхронистичность как акаузальные связи через смысл. Эти системы превосходно выделяют повторяющиеся темы, запуская самопознание и сонастройку с вашей внутренней истиной.",
    psychologicalTitle: "Психологическая отражающая сила",
    psychologicalDesc: "Даже без физических доказательств эти системы функционируют как мощные терапевтические зеркала: они побуждают к самоисследованию, подсвечивают потенциалы и обеспечивают структуру для перевода интуиции в слова.",
    freeWillDisclaimer: "«Мы никогда не обещаем предсказания как несомненность — свобода воли, выбор и контекст всегда формируют результаты. Космос освещает возможности; вы решаете, как по ним идти».",
    saveCherishTitle: "Сохранить и Беречь",
    saveCherishDesc: "Загрузите свое чтение в виде элегантного PDF: космический дизайн, готовый к печати или в качестве значимого подарка.",
    privacySovereigntyTitle: "Конфиденциальность и Суверенитет",
    privacySovereigntyDesc: "Ваши координаты обрабатываются только в течение сессии. Данные удаляются сразу после создания вашего PDF.",
    readyToListen: "Готовы слушать?",
    consultSecretLanguage: "Обратиться к Секретному Языку",
    finalLegalDisclaimer: "Заключительное напоминание: это инструмент для развлечения, вдохновения и саморефлексии. Он не является заменой профессиональной медицинской, финансовой или юридической консультации. Вы — автор своей судьбы.",
    testimonialsTitle: "Эхо Душ",
    testimonialsSubtitle: "Голоса тех, кто прошел этот путь до вас.",
    privacyPolicy: "Политика Конфиденциальности",
    contactSupport: "Контакт • Предложения • Поддержка",
    testimonial1Quote: "Потрясающе.",
    testimonial1Text: "Наконец-то что-то, что действительно откликается. Совет про «Проектора» попал в точку. Такое ощущение, что они знают меня всю жизнь.",
    testimonial2Quote: "Так точно!",
    testimonial2Text: "Отчет прекрасен и очень глубок. Я распечатала свой Указ и положила его на стол. Это дает мне столько спокойствия.",
    testimonial3Quote: "Просто идеально.",
    testimonial3Text: "Обожаю золотые звезды! Слова правдивы, а PDF очень хорош. Моя судьба теперь ясна. 10/10.",
    timeLabel: "Время:",
    whenDidItHappen: "Когда это произошло?",
    approximateTime: "Приблизительное время:",
    shareTitle: "Указ Atlantic Oracle™",
    shareText: "Я только что получил свое личное космическое чтение от Atlantic Oracle™! 🌌 Исследуйте свой путь на atlanticoracle.com",
    latestTransmission: "Последняя Трансляция",
    readFullGazette: "Читать Полную Газету",
    joinedBySeekers: "На этой неделе присоединилось более 1200 ищущих",
    newsSubtitle: "Небесные трансляции для современной души.",
    viewAllNews: "Посмотреть все новости",
    formName: "Полное Имя",
    formBirthDate: "Дата Рождения",
    formBirthDatePlaceholder: "ДД.ММ.ГГГГ",
    formBirthPlace: "Место Рождения",
    formBirthPlacePlaceholder: "Город, Страна",
    formBirthTime: "Время Рождения",
    formBirthTimePlaceholder: "например, 14:30 или 2:30 PM",
    formBirthTimeHelp: "Используйте 24-часовой формат (14:30) или 12-часовой формат с AM/PM (2:30 PM).",
    formHours: "Часы",
    formMinutes: "Минуты",
    formAM: "AM",
    formPM: "PM",
    ...
    formEmailPlaceholder: "your@email.com",
    formEmailHelp: "Требуется только для отправки вашего отчета Оракула и гарантии того, что вы его не потеряете.",
    formGoal: "Ваша Цель",
    ...
    cookieRejectAll: "Только Основные",
    cookieSettings: "Настройки",
    privacySettingsTitle: "Настройки Конфиденциальности",
    privacySettingsDesc: "Управляйте тем, как ваши данные взаимодействуют с космической сетью.",
    privacyEssentialCookies: "Основные Cookie",
    privacyEssentialDesc: "Необходимы для базовой функциональности и безопасности. Не могут быть отключены.",
    privacyAnalyticsCookies: "Аналитика",
    privacyAnalyticsDesc: "Помогает нам понять, как ищущие взаимодействуют с Оракулом.",
    privacyMarketingCookies: "Маркетинг",
    privacyMarketingDesc: "Используется для обмена космическими новостями и обновлениями с соответствующими ищущими.",
    saveSettings: "Сохранить Настройки",
    dataRightsTitle: "Ваши Права на Данные",
    dataRightsDesc: "В соответствии с GDPR вы имеете право на доступ, экспорт или удаление ваших священных данных.",
    requestDataExport: "Запросить Экспорт Данных",
    requestDataDeletion: "Запросить Удаление Данных",
    navDealer: "Стать Дилером",
    dealerContactTitle: "Быстрая связь:",
    dealerContactWhatsApp: "WhatsApp Чат",
    dealerContactTelegram: "Telegram Чат",
    pitchButton: "Как монетизировать ваш SMM-канал?",
    pitchSlide1Title: "Монетизируйте магию вашего контента",
    pitchSlide1Subtitle: "P2P Партнерская платформа: Профессиональная Астрология и Нумерология для вашей аудитории.",
    pitchSlide2Title: "Проблемы монетизации SMM-каналов",
    pitchSlide2Point1: "Низкие выплаты от прямой рекламы.",
    pitchSlide2Point2: "Сложность поиска качественного продукта для рекомендаций.",
    pitchSlide2Point3: "Недоверие аудитории к «пустым» предложениям.",
    pitchSlide2Message: "Вы создаете контент, но платформы забирают основную прибыль.",
    pitchSlide3Title: "Atlantic Oracle — Готовый бизнес в вашем смартфоне",
    pitchSlide3Desc: "Мы создали платформу персонального анализа, которая превращает подписчиков в лояльных клиентов.",
    pitchSlide3Feature1: "Высококачественные автоматизированные отчеты.",
    pitchSlide3Feature2: "Два языка: Английский и Португальский (BR).",
    ...
    pitchSlide5Partner: "Для вас: 50% от чистой прибыли с каждой продажи.",
    pitchSlide5Result: "Результат: Лояльная аудитория (вы дали пользу со скидкой) + высокий доход.",
    pitchSlide6Title: "Финансовая прозрачность со Stripe",
    pitchSlide6Text1: "Мы не просим вас верить нам на слово.",
    pitchSlide6Text2: "Интеграция с мировым лидером платежей — Stripe.",
    pitchSlide6Text3: "Еженедельные отчеты о транзакциях прямо из системы.",
    pitchSlide6Text4: "Выплаты без задержек по расписанию.",
    pitchSlide6Visual: "Еженедельные выплаты",
    pitchSlide7Title: "Глобальный охват: EN и PT-BR",
    pitchSlide7En: "Английский: Доступ к премиальной аудитории по всему миру.",
    pitchSlide7Pt: "Португальский (Бразилия): Самый быстрорастущий и лояльный эзотерический рынок в мире.",
    ...
    pitchSlide2Badge: "Проблема",
    pitchSlide3Badge: "Решение",
    pitchSlide4Badge: "Продукт",
    pitchSlide5Badge: "Предложение",
    pitchSlide6Badge: "Доверие",
    pitchSlide7Badge: "Возможность",
    pitchSlide8Badge: "Тренд Рынка",
    pitchSlide9Badge: "Онбординг",
    pitchSlide10Badge: "Заключение",
    pitchSlide5ClientTitle: "Для вашего Клиента",
    pitchSlide5PartnerTitle: "Для Вас",
    pitchWinWin: "Взаимовыгодное Партнерство",
    pitchDealerProgram: "Дилерская Программа",
    pitchDealerSubtitle: "Монетизируйте свою аудиторию, делясь мудростью звезд и чисел.",
    dailyVibrationTitle: "The Daily Vibration (Ключ Транзита)",
    dailyVibrationSlogan: "Ваша личная «Частота Дня» и конкретная мантра действий для сонастройки с сегодняшними транзитами.",
    dailyVibrationDesc: "Краткий расчет того, как сегодняшние положения планет резонируют лично с вашей картой. Вы получаете одну ключевую рекомендацию: что инициировать сегодня, а от чего воздержаться, плюс личную аффирмацию.",
    relationshipSparkTitle: "The Relationship Spark (Быстрая проверка совместимости)",
    relationshipSparkSlogan: "1-минутный снимок химии. Узнайте основной «вайб» или «урок» между вами и другим человеком.",
    relationshipSparkDesc: "Экспресс-анализ совместимости на основе двух дат рождения. Вместо 5 страниц текста вы получаете четкое определение типа связи: «Кармический Учитель», «Зеркало», «Донор Энергии» или «Творческий Союз». Идеально для быстрой проверки нового контакта.",
    horoscopeTitle: "Личный Гороскоп на Завтра",
    horoscopeSubtitle: "Выберите свой знак зодиака, чтобы получить небесный прогноз.",
    horoscopeLoading: "Консультация со звездами на завтра...",
    horoscopeCTA: "Изучить Другие Услуги",
    horoscopeInvite: "Звездам есть что вам рассказать. Изучите наши всеобъемлющие космические указы.",
    horoscopeForecastLabel: "Небесный Прогноз",
